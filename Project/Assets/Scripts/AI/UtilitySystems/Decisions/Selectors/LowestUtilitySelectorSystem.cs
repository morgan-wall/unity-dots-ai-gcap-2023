...
namespace AI.UtilitySystems.Decisions.Selectors
{
    ...
    public partial struct LowestUtilitySelectorSystem : ISystem
    {
        ...
        {
            var job = new LowestUtilitySelectorJob();
    ...
    [BurstCompile]
    public partial struct LowestUtilitySelectorJob : IJobEntity
    {
        [ReadOnly]
        public ComponentLookup<OptionEvaluator> OptionEvaluatorLookup;
        
        private void Execute(in LowestUtilitySelector selector,
